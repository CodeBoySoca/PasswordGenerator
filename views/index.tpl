...
<body>
  <div id="content">
   ...
   <div id="password">
     <span id="generated-password">Number of characters</span>
    ...
    <footer>
     <div>
       <select name="character-type" id="character-type">
        ...
        <input type="number" id="character-count"  name="character-count" placeholder="Number of characters" min="8" max="48" step="1" >
        </div>
    </footer>
  </div>
